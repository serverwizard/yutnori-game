...
export const TOSS_RESULTS = Object.freeze({
  ...
  BACKDO: Object.freeze({ key: 'BACKDO', name: '백도', steps: -1, again: false }),
});
...
/**
 * @param {boolean[]} flats 각 윷가락의 배(평평한 면)가 위인지. 길이 4. flats[0] 이 백도 표시 가락.
 * @param {boolean} backdoEnabled
 */
